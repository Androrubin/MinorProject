...
class PlaceOrderPage extends StatefulWidget {
  final List<FoodItem> selectedItems; // Property to store the selected items
...
class _PlaceOrderPageState extends State<PlaceOrderPage> {
  ...
  void calculateTotalPrice() {
    int newTotalPrice = 110; // Initialize a temporary variable
    for (var item in _selectedItems) {
      newTotalPrice += item.itemCount * int.parse(item.price);
    }
    setState(() {
                      ...
                      itemBuilder: (context, index) {
                        return SelectedItemCard(
                          ...
                          onQuantityChanged: (newQuantity) {
                            // Handle the quantity change here, such as updating the total price.
                            // You can access the new quantity via the newQuantity parameter.
                            // For example:
                            setState(() {
                              _selectedItems[index].itemCount = newQuantity;
                              // Update your total price or perform any other necessary actions.
                            });
                          },
                        );
                      },
