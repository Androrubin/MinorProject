...
class _ExtraPageState extends State<ExtraPage>{
  ...
  void updateArrowButtonVisibility(bool isVisible) {
    setState(() {
...
class ItemCard extends StatefulWidget {
 ...
 // final Function(bool isVisible) updateVisibilityCallback;
  // final Function press;
  const ItemCard({
    required Key key,
    required this.foodItem,
   // required this.updateVisibilityCallback,
    //   required this.press
  }) : super(key: key);
...
class _ItemCardState extends State<ItemCard> {
  ...
  void toggleItemSelection(FoodItem item) {
    setState(() {
      ...
      isButtonVisible = selectedItems.isNotEmpty;// Toggle the selected state
    });
  }
  @override
  Widget build(BuildContext context) {
